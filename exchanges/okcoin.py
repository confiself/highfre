...
if __name__ == '__main__':
    ...
    actived_exchanges = OKCoinExchange(cfg['okcoin'])
    _logger.debug(actived_exchanges.BASE_URL)
    _logger.info(actived_exchanges.login())
    _logger.info(actived_exchanges.request_info())
    _logger.info(actived_exchanges.request_ticker())
